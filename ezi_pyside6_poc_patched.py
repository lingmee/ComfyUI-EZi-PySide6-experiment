"""
ComfyUI-EZi - PySide6 Proof of Concept (PATCHED)
Minimal test to verify frameless window behavior + working JS-Python bridge.
"""
...
# ---------------------------------------------------------------------------
# 3. HTML Test Page (dummy bridge removed so we can verify real connection)
# ---------------------------------------------------------------------------
    ...
    def _inject_webchannel_scripts(self):
        ...
        (function() {
            ...
            new QWebChannel(qt.webChannelTransport, function(channel) {
                ...
                var result = document.getElementById('result');
                if (result) result.textContent = "Qt bridge connected!";
            });
        })();
        """
...
def main():
    print("=" * 60)
    print("ComfyUI-EZi - PySide6 Proof of Concept (PATCHED)")
    print("=" * 60)
    ...
    print(f"  8. Click web buttons (Test Minimize etc.) -> console should show [Bridge] Received action")
